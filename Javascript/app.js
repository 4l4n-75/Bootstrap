...
// class Perro{
//     constructor(raza, edad, color, competir){
//         this.raza=raza;
//         this.edad=edad;
//         this.color=color;
//         this.competir=competir || false;
//     };
//     ladra (){
//         console.log('ladra')
//     };
...
//         }else{
//             console.log('no es de raza')
//         }
//     }

//     static callejeros(){
//         callejeros.push(new Perro('meztizo','4-5', 'negro', true))
//     }

// }

//Ejercicio incremental 11 (Objetos / Clases)
// let usuarios = new Array();
// const count = 2 ;
// let usuario;
// class Usuario{
//     constructor(nombre, apellido, edad, sexo, email){
//         this.nombre=nombre;
...
//     }
//     ingreso(){
//         console.log(`Bievenid@ ${this.nombre} ${this.apellido}`)
//     }    
// };
// function registra(){
//      for (let i = 0; i < count; i++) {
...
//         usuario = new Usuario(nombre, apellido, edad, sexo, email)
